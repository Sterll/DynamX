...
/**
 * <p>TODO port:1.20.1 - no MC API used directly; only removed the dead 1.12 import on
 * {@code MessagePacksHashs} (still referenced from {@code PackSyncHandler}, no change in signature).</p>
 */
public class UdpClientNetworkHandler implements IDnxNetworkHandler {
    ...
    public boolean start() {
        ...
        while (running) {
            byte[] packetBuffer = UDPByteArrayPool.getINSTANCE().get();
