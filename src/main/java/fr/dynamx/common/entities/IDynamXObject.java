...
/**
 * DynamX objects that have complex collisions with players, for example {@link PhysicsEntity} and TEDynamXBlock <br>
 * <br>
 * The collision is handled in the {@link fr.dynamx.api.physics.IRotatedCollisionHandler}
 */
// TODO port:1.20.1 - TEDynamXBlock (fr.dynamx.common.blocks.TEDynamXBlock) is not ported yet (Phase 8);
// removed from javadoc references to avoid import on an unported class.
