...
/**
 * TODO port:1.20.1 - Original used net.minecraft.util.math.AxisAlignedBB; replaced by
 *   net.minecraft.world.phys.AABB in 1.20.1. AABB#minX/minZ remain double-typed.
 *
 * TODO port:1.20.1 - getDebugOption() originally returned DynamXDebugOptions.WHEELS
 *   (fr.dynamx.utils.debug). Returning null until that package is ported.
 */
@Getter
@Setter
