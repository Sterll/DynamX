 ...
 * @see ObjectInfo
 *
 * TODO port:1.20.1 - The legacy class also imported DynamXItemRegistry, ContentPackUtils and
 *   ProgressManager / FMLCommonHandler for the inlined updateItems logic. Those pieces have
 *   been moved into the shared {@link InfoList#updateItems} helper and stubbed for Phase 6
 *   (items registry rework). This file only delegates.
 */
public class ObjectLoader<T extends ObjectInfo<?> & ISubInfoTypeOwner<?>, C extends IDynamXItem<?>> extends InfoLoader<T> {
     ...
     * @return The object, to use in classes extending DynamX ones (example : fr.dynamx.common.blocks.DynamXBlock)
