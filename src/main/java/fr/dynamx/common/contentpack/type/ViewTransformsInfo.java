...
/**
 * Item transforms for a specific {@link net.minecraft.world.item.ItemDisplayContext}
 *
 * @see ItemTransformsInfo
 *
 * TODO port:1.20.1 - Original used net.minecraft.client.renderer.block.model.ItemCameraTransforms.TransformType.
 *   In 1.20.1 the equivalent is net.minecraft.world.item.ItemDisplayContext. The EnumViewType
 *   enum now wraps ItemDisplayContext entries (FIRST_PERSON_LEFT_HAND, GUI, etc.).
 */
...
public class ViewTransformsInfo extends SubInfoType<ItemTransformsInfo> {
    ...
    public void appendTo(ItemTransformsInfo owner) {
        ...
        Vector3f translate = getItemTranslate();
    ...
    public enum EnumViewType {
        THIRD_PERSON_LEFT_HAND(ItemDisplayContext.THIRD_PERSON_LEFT_HAND, "ThirdPersonLeftHand", "TPLH"),
        THIRD_PERSON_RIGHT_HAND(ItemDisplayContext.THIRD_PERSON_RIGHT_HAND, "ThirdPersonRightHand", "TPRH"),
        FIRST_PERSON_LEFT_HAND(ItemDisplayContext.FIRST_PERSON_LEFT_HAND, "FirstPersonLeftHand", "FPLH"),
        FIRST_PERSON_RIGHT_HAND(ItemDisplayContext.FIRST_PERSON_RIGHT_HAND, "FirstPersonRightHand", "FPRH"),
        HEAD(ItemDisplayContext.HEAD, "Head"),
        GUI(ItemDisplayContext.GUI, "Gui"),
        GROUND(ItemDisplayContext.GROUND, "Ground"),
        FIXED(ItemDisplayContext.FIXED, "Fixed");

        private final ItemDisplayContext transformType;
        private final String[] names;

        EnumViewType(ItemDisplayContext transformType, String... names) {
