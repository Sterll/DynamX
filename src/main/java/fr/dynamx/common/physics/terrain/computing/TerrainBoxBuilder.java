...
public interface TerrainBoxBuilder {
    ...
    class StairsTerrainBoxBuilder implements TerrainBoxBuilder {
        ...
        public StairsTerrainBoxBuilder(double minX, double minY, double minZ, double startYSize, Direction facing, boolean upper) {
            this.minX = minX;
            this.minY = minY;
            this.minZ = minZ;
        ...
        protected StairsBox compile() {
            return facing.getAxis() == Direction.Axis.X ? new StairsBox((float) minZ, (float) (minZ + cursorZ + 1), (float) minY, (float) minX, upper, facing) :
