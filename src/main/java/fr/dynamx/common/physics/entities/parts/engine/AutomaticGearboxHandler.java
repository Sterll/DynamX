...
public abstract class AutomaticGearboxHandler {
    ...
    public static class CarGearBox extends AutomaticGearboxHandler {
        ...
        protected float getVehicleSpeed() {
            ...
            // TODO port:1.20.1 - Side.SERVER replaced by LogicalSide.SERVER
            wheelRotationSpeed *= (float) (3.6 * 20 * 0.05f / DynamXContext.getPhysicsSimulationMode(LogicalSide.SERVER).getTimeStep());
