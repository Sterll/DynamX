...
public interface IBlockCollisionBehavior {
     ...
     */
    default TerrainBoxBuilder initBoxBuilder(TerrainBoxConstructor terrainBoxConstructor, Level world, BlockPos mutable, BlockState boxStart, double ox, double oy, double oz) {
        // TODO port:1.20.1 - getBoundingBox(world, pos) replaced; using getShape().bounds() approximation
     ...
     */
    boolean applies(BlockGetter world, BlockPos pos, BlockState toBlock);
     ...
     */
    default boolean isStackableBlock(BlockGetter world, BlockPos pos, BlockState blockState) {
        return true;
    }
     ...
     */
    boolean stacks(BlockGetter world, BlockPos pos, Direction.Axis axis, BlockState onBlock, BlockState stackingBlock, @Nullable BlockState lastStacked);
     ...
     */
    void addBlockCollision(TerrainBoxConstructor terrainBoxConstructor, @Nullable TerrainBoxBuilder boxBuilder, TerrainCollisionsCalculator.TerrainCursor cursor, Level world, BlockPos at, BlockState ofBlock, @Nullable Direction.Axis axis);
