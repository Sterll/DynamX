...
public enum SimulationHolder {
    ...
    public boolean ownsPhysics(LogicalSide side) {
        return side == LogicalSide.CLIENT ? this.hasClientPhysics : this == SERVER;
    }
     ...
     */
    public boolean ownsControls(LogicalSide side) {
        return side == LogicalSide.CLIENT
                ? (this == DRIVER || this == DRIVER_SP)
                : (this == DRIVER || this == SERVER || this == SERVER_SP);
    }
     ...
     */
    public boolean isPhysicsAuthority(LogicalSide currentSide) {
        return (!this.isSinglePlayer() && currentSide == LogicalSide.SERVER) || ownsPhysics(currentSide);
    }
