...
/**
 * Handles sync of attached bodies, via the EntityTransformsVariable
 */
// TODO port:1.20.1 - fr.dynamx.common.network.sync.variables.EntityTransformsVariable is not ported yet (Phase 5).
